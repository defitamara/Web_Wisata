  ...
  <main id="main">
    ...
    <section id="portfolio" class="section-bg">
      ...
      <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-k1">
          <div class="portfolio-wrap">
            <figure>
              <img src="/data/data_galeri/{{ $item->foto }}" class="img-fluid" alt="">
              <a href="/data/data_galeri/{{ $item->foto }}" data-lightbox="portfolio" data-title="App 1" class="link-preview"><i class="bi bi-plus"></i></a>
              {{-- <a href="portfolio-details.html" class="link-details" title="More Details"><i class="bi bi-link"></i></a> --}}
            </figure>

            <div class="portfolio-info">
              <h4><a href="#">{{ $item->caption }}</a></h4>
              <p>{{ \Carbon\Carbon::parse($item->updated_at)->translatedFormat('l, d F Y') }}</p>
            </div>
          </div>
        </div>
        @endforeach
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-k2">
          <div class="portfolio-wrap">
            <figure>
              <img src="/data/data_galeri/{{ $item->foto }}" class="img-fluid" alt="">
              <a href="/data/data_galeri/{{ $item->foto }}" data-lightbox="portfolio" data-title="App 1" class="link-preview"><i class="bi bi-plus"></i></a>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-k5">
          <div class="portfolio-wrap">
            <figure>
              <img src="/data/data_galeri/{{ $item->foto }}" class="img-fluid" alt="">
              <a href="/data/data_galeri/{{ $item->foto }}" data-lightbox="portfolio" data-title="App 1" class="link-preview"><i class="bi bi-plus"></i></a>
