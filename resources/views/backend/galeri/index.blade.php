          ...
          <!-- ============================================================== -->
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="{{ route('galeri.create') }}" class="card-title">
                  ...
                  <div class="table-responsive">
                    ...
                    >
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>{{ $no++ }}</td>
                          <td><img src="/data/data_galeri/{{ $item->foto }}" width="100"></td>
                          ...
                          <form action="{{ route('galeri.destroy',$item->id_foto)}}" method="POST">
                            @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger btn-sm text-white" 
                                onclick="return confirm('Apakah Anda yakin ingin menghapus foto {{ $item->caption }} ini?')">
