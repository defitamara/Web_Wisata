          ...
          {{-- <div class="row"> --}}
            {{-- <div class="col-md-6"> --}}
              <div class="card">
                ...
                action="{{ route('galeri.update',$galeri->id_foto) }}">
                ...
                <input type="hidden" name="id_foto" value="{{ isset($galeri) ? $galeri->id_foto : '' }}">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-13">
                        <div class="custom-file">
                          <input type="hidden" name="nama_foto" value="{{ isset($galeri) ? $galeri->foto : '' }}">
                          <td><img src="/data/data_galeri/{{ isset($galeri) ? $galeri->foto : '' }}" width="100"></td>
                          <input
                            type="file"
                            id="foto" name="foto"
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-13">
                        <input
                          ...
                          value="{{ isset($galeri) ? $galeri->caption : '' }}"/>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label
                      ...
                      {{-- <div class="col-sm-13">
                        ...
                        <div class="col-md-13">
                          <select name="id_ktg"
                            ...
                            <option value="KAT01" {{ ($galeri->id_ktg=="KAT01")? "selected" : "" }}>Tirta Agung</option>
                            <option value="KAT02" {{ ($galeri->id_ktg=="KAT02")? "selected" : "" }}>Kala Senja</option>
                            <option value="KAT03" {{ ($galeri->id_ktg=="KAT03")? "selected" : "" }}>Berita</option>
                            <option value="KAT04" {{ ($galeri->id_ktg=="KAT04")? "selected" : "" }}>Hiburan</option>
                          </select>
                        </div>
                    </div>
